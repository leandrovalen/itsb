...
if($('#map').length >0 ) {
  ...
  function init() {
      ...
      //var myLatlng = new google.maps.LatLng(40.69847032728747, -73.9514422416687); LATITUD Y LONGITUD DEL MAPA ANTERIOR
      var myLatlng = new google.maps.LatLng(-34.7711953, -58.430491);
      var mapOptions = {
